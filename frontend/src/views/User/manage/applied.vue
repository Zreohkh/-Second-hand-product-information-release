<template>
      ...
      <el-row>
        <el-col :span="24">
          <el-row :gutter="20">
            ...
            <el-col :span="2.5">
            <el-button type="danger" @click="batchDeletetrade"
              >批量删除</el-button
            >
          </el-col>
          </el-row>
          ...
          <el-table
            ...
            <el-table-column prop="contact" label="联系方式">
              <template slot-scope="scope">
                <span v-html="formatContact(scope.row.contact)"></span>
              </template>
            </el-table-column>
  ...
  <script>
  import { tradeList, tradeDelete, tradeBatchDelete} from "@/api/trade";
  export default {
    data() {
      return {
        uploadData: {ppid:""},
